...
import { updateNewMember, addMemeber } from "../actions/dragonListActions";
...
class DragonList extends React.Component {
  handleClick = () => {
    ...
    this.props.addMemeber(newMember);
  };
...
export default connect(mapStateToProps, { updateNewMember, addMemeber })(
  DragonList
);
